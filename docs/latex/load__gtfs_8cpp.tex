...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{load__gtfs_8cpp_a4f311128b9bf5549011dc5d2a288a0b0}\label{load__gtfs_8cpp_a4f311128b9bf5549011dc5d2a288a0b0}} 
...
For each segment
\begin{DoxyItemize}
\item find intersections on the segment
\item split at intersections
\begin{DoxyItemize}
\item S\+P\+L\+IT = from nearest point on path to A to nearest point on path to B, I\+N\+C\+L\+U\+S\+I\+VE
\end{DoxyItemize}
\item for each S\+P\+L\+IT, look for existing segment between A and B
\begin{DoxyItemize}
\item IF exists, use that,
\item E\+L\+SE create new segment
\end{DoxyItemize}
\item compare length of original with new\+:
\begin{DoxyItemize}
\item IF equal, then replace all rows of S\+H\+A\+P\+ES with new segments
\begin{DoxyItemize}
\item and delete the original segment
\end{DoxyItemize}
\item E\+L\+SE report an error creating the segment
\end{DoxyItemize}
\end{DoxyItemize}
