...
int {\bfseries system} (std\+::string const \&s)
\item 
...
void {\bfseries convert\+\_\+shapes} (sqlite3 $\ast$db)
\item 
...
void {\bfseries import\+\_\+intersections} (sqlite3 $\ast$db, std\+::vector$<$ std\+::string $>$ files)
\item 
